            ...
            <div className='home_section_container'>
                ...
                <div className='card_collection'>
                    <div className='collabration_card'>
                        <img src={AOL} className='collabration_img'alt="AOL" />
                        <div className='collabration_content'>The Art of Living Foundation is a renowned international non-profit organization founded by Gurudev Sri Sri Ravi Shankar.</div>
                        <button className='home_button'>Read More</button>
                    </div>
                    <div className='collabration_card'>
                        <img src={SSF} className='collabration_img' alt="SSF" />
                        <div className='collabration_content'>The Samarasata Sewa Foundation is a non-profit organization committed to promoting equality, harmony, and social justice.</div>
                        <button className='home_button'>Read More</button>
                    </div>
                    <div className='collabration_card'>
                        <img src={OVBI} alt="OVBI" className='collabration_img'  />
                        <div className='collabration_content'>OVBI is an organization that aims to mobilize the Indian diaspora and stakeholders in contributing to India's development.</div>
                        <button className='home_button'>Read More</button>
                    </div>
                </div>
            </div>
                ...
                <div className='card_collection'>
                    <div className='achievement_card'>
                        <div className='achievement_card_content'>
                            <div className='achievement_card_number'>1300+</div>
